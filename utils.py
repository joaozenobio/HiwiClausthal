...
def determine_orientation_region(img, yaw, pitch, roll):
    if -15. < yaw < 15. and -15. < pitch < 15.:
        text = "center"
    elif -15. < yaw < 15. and pitch > 15.:
            text = "up"
    elif -15. < yaw < 15. and pitch < -15.:
            text = "down"
    elif -15. < pitch < 15. and yaw > 15.:
            text = "right"
    elif -15. < pitch < 15. and yaw < -15.:
            text = "left"
    elif pitch > 15. and yaw > 15.:
        text = "up right"
    elif pitch > 15. and yaw < -15.:
        text = "up left"
    elif pitch < -15. and yaw > 15.:
    ...
    img = cv2.putText(img, text, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0),
                      1, cv2.LINE_AA)
    return img
